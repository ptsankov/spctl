...
R4: Visitors and employees cannot access the lobby without their pin from midnight outside of workhours
((and (not pin) (not (time in [8,20])) (role in {visitor hr researcher it})), (not (EF (zone in {lobby}))))

R5: Employees can always access the lobby with their PIN
((and pin (role in {hr researcher it})), (EF (zone in {lobby})))

R6: Visitors can access one of the restrooms if they have access to a meeting room
...
R12: IT and researcher employees cannot access the post office
((not (role in {postman hr})), (not (EF (zone in {post}))))

R13: Only IT can access the server room
